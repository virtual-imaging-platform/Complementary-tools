...
#      PASSPHRASE="pou joujou hibou genou chou caillou bijou"
...
sed \
    ...
    -e 's/PASSPHRASE=MODIFY/PASSPHRASE="pou joujou hibou genou chou caillou bijou"/' \
    ...
    -e 's#https://raw.githubusercontent.com/virtual-imaging-platform/Complementary-tools/master#https://raw.githubusercontent.com/wassong-iphc/Complementary-tools/cloud-init-dev#' \
